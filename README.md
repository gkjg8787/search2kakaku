...
- [起動](#起動)
- [使い方](#使い方)
  - [`search.py` - 商品の検索と価格情報の初期登録](#searchpy---商品の検索と価格情報の初期登録)
  - [`register_for_updates.py` - 自動更新対象の管理](#register_for_updatespy---自動更新対象の管理)
  - [`update_urls.py` - 価格情報の更新](#update_urlspy---価格情報の更新)
  - [`send_to_api.py` - `kakakuscraping-fastapi`との連携](#send_to_apipy---kakakuscraping-fastapiとの連携)
  - [`view_log.py` - コマンドログの表示](#view_logpy---コマンドログの表示)
